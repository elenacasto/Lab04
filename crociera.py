...
class Crociera:
        ...
        with open(file_path, "r", encoding="utf-8") as file:
            for line in file:
                ...
                if line[0].startswith("CAB"):
                    ...
                    if len(line) == 4:
                        cabina = CabinaStandard(codice_cabina, num_letti, ponte, prezzo)
                    elif line[4].isdigit():
                        max_animali = int(line[4])
                        cabina = CabinaAnimali(codice_cabina, num_letti, ponte, prezzo, max_animali)
                    else :
                        stile_deluxe = line[4]
                        cabina = CabinaDeluxe(codice_cabina, num_letti, ponte, prezzo, stile_deluxe)
    ...
    def assegna_passeggero_a_cabina(self, codice_cabina, codice_passeggero):
        ...
        passeggero = next((p for p in self._passeggeri if p.codice == codice_cabina), None)
